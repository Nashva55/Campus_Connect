...
function openModal() {
  ...
  document.getElementById("edit-college").value = document.getElementById("display-college").innerText.replace(/^🏛 /, "");
  document.getElementById("edit-year").value    = document.getElementById("display-year").innerText.replace(/^📅 /, "");
  document.getElementById("edit-email").value   = document.getElementById("display-email").innerText.replace(/^✉️ /, "");
  ...
  if (pic.style.backgroundImage && pic.style.backgroundImage !== "none") {
    ...
    preview.innerHTML = `<span id="pickerIcon">👤</span>`;
...
function removeProfilePhoto() {
  document.getElementById("pickerPreview").innerHTML = `<span id="pickerIcon">👤</span>`;
...
editForm.addEventListener("submit", function (e) {
  ...
  document.getElementById("display-college").innerText = "🏛 " + document.getElementById("edit-college").value;
  document.getElementById("display-year").innerText    = "📅 " + document.getElementById("edit-year").value;
  document.getElementById("display-email").innerText   = "✉️ " + document.getElementById("edit-email").value;
  ...
  if (pending === "remove") {
    ...
    pic.innerHTML = `<span class="avatar-icon">👤</span><div class="photo-overlay" onclick="openModal()">Change</div>`;
  } else if (pending) {
  ...
  card.innerHTML = `
    ...
    <div class="post-card-body">
      ...
      <div class="post-card-actions">
        ...
        <button class="delete-post-btn" onclick="deletePost(${post.id})">🗑</button>
      </div>
    </div>`;
...
function openPostViewer(id, focusComment = false) {
  ...
  const avatar = avatarBg
    ...
    : `<div class="comment-avatar" style="width:30px;height:30px;">👤</div>`;
